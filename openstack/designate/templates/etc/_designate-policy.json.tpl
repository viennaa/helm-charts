{
    ...
    "context_is_mailmaster": "rule:context_is_dns_support or rule:context_is_hostmaster or (role:dns_mailmaster and rule:owner)",
    "context_is_webmaster": "rule:context_is_dns_support or rule:context_is_mailmaster or (role:dns_webmaster and rule:owner)",
    ...
    "create_A_recordset": "rule:context_is_webmaster",
    "create_AAAA_recordset": "rule:context_is_webmaster",
    "create_CNAME_recordset": "rule:context_is_webmaster",
    "create_MX_recordset": "rule:context_is_mailmaster",
    "create_NS_recordset": "rule:context_is_hostmaster",
    "create_PTR_recordset": "rule:context_is_webmaster",
    "create_SOA_recordset": "!",
    "create_SPF_recordset": "rule:context_is_mailmaster",
    "create_SRV_recordset": "rule:context_is_webmaster",
    "create_SSHFP_recordset": "rule:admin",
    "create_TXT_recordset": "rule:context_is_webmaster",

    "update_A_recordset": "rule:context_is_webmaster",
    "update_AAAA_recordset": "rule:context_is_webmaster",
    "update_CNAME_recordset": "rule:context_is_webmaster",
    "update_MX_recordset": "rule:context_is_mailmaster",
    "update_NS_recordset": "rule:context_is_hostmaster",
    "update_PTR_recordset": "rule:context_is_webmaster",
    "update_SOA_recordset": "!",
    "update_SPF_recordset": "rule:context_is_mailmaster",
    "update_SRV_recordset": "rule:context_is_webmaster",
    "update_SSHFP_recordset": "rule:admin",
    "update_TXT_recordset": "rule:context_is_webmaster",

    "delete_A_recordset": "rule:context_is_webmaster",
    "delete_AAAA_recordset": "rule:context_is_webmaster",
    "delete_CNAME_recordset": "rule:context_is_webmaster",
    "delete_MX_recordset": "rule:context_is_mailmaster",
    "delete_NS_recordset": "rule:context_is_hostmaster",
    "delete_PTR_recordset": "rule:context_is_webmaster",
    "delete_SOA_recordset": "!",
    "delete_SPF_recordset": "rule:context_is_mailmaster",
    "delete_SRV_recordset": "rule:context_is_webmaster",
    "delete_SSHFP_recordset": "rule:admin",
    "delete_TXT_recordset": "rule:context_is_webmaster",

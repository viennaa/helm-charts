...
{{- end }}
    ...
    "identity:get_role": "rule:admin_required or rule:cloud_viewer",
    "identity:list_roles": "rule:admin_required or rule:cloud_viewer",
...
{{- end }}
    ...
    "identity:list_system_grants_for_user": "rule:admin_required or rule:cloud_viewer",
    "identity:check_system_grant_for_user": "rule:admin_required or rule:cloud_viewer",
    "identity:create_system_grant_for_user": "rule:admin_required",
    "identity:revoke_system_grant_for_user": "rule:admin_required",

    "identity:list_system_grants_for_group": "rule:admin_required or rule:cloud_viewer",
    "identity:check_system_grant_for_group": "rule:admin_required or rule:cloud_viewer",
    ...
    "identity:get_consumer": "rule:admin_required or rule:cloud_viewer",
    "identity:list_consumers": "rule:admin_required or rule:cloud_viewer",
